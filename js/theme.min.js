...
<html class="relearn ${g}-mode" lang="${lang}" dir="${isRtl?"rtl":"ltr"}" data-r-output-format="${r}" data-r-theme-variant="${p}">
  <head>
    <meta charset="utf-8">
