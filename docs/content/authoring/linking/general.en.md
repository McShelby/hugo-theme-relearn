...
frontmatter = ['urlExternalCheck']
options = ['urlExternalCheck']
title = 'General'
weight = 1
+++
...
For local URLs images are searched in the resources of the current page and your global `assets` directory.
