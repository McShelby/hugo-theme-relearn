...
- {{% badge style="breaking" %}}Breaking{{% /badge %}} When the theme introduced compatiblity with Hugo {{% badge style="hugo" %}}0.146.7{{% /badge %}} it had to remove a performance optimization due to a limitation in Hugo. This was later fixed in Hugo {{% badge style="hugo" %}}0.149.0{{% /badge %}}.
