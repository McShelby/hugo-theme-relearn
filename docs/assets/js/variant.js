  ...
  structure: {
    children: [
      ...
      },
      {
        ...
        variables: [
          { name: 'MENU-SCROLLBAR-THUMB-color', default: 'color-mix(in srgb, var(--INTERNAL-MENU-SECTIONS-LINK-color) 50%, transparent)', tooltip: 'thumb color of the scrollbar of the menu' },
          { name: 'MENU-SCROLLBAR-THUMB-HOVER-color', default: 'color-mix(in srgb, var(--INTERNAL-MENU-SECTIONS-LINK-color) 75%, transparent)', tooltip: 'hovered thumb color of the scrollbar of the menu' },
          { name: 'MENU-SCROLLBAR-TRACK-color', default: 'transparent', tooltip: 'track color of the scrollbar of the menu' },
          { name: 'MENU-SCROLLBAR-TRACK-HOVER-color', default: 'rgba(134, 134, 134, .167)', tooltip: 'hovered track color of the scrollbar of the menu' },
      ...
      },
      {
        ...
        variables: [
          ...
          { name: 'TOPBAR-SCROLLBAR-THUMB-color', default: 'color-mix(in srgb, var(--INTERNAL-TOPBAR-TEXT-color) 50%, transparent)', tooltip: 'thumb color of the scrollbar of topbar popover areas' },
          { name: 'TOPBAR-SCROLLBAR-THUMB-HOVER-color', default: 'color-mix(in srgb, var(--INTERNAL-TOPBAR-TEXT-color) 75%, transparent)', tooltip: 'hovered thumb color of the scrollbar of topbar popover areas' },
          { name: 'TOPBAR-SCROLLBAR-TRACK-color', default: 'rgba(134, 134, 134, .1)', tooltip: 'track color of the scrollbar of topbar popover areas' },
          { name: 'TOPBAR-SCROLLBAR-TRACK-HOVER-color', default: 'rgba(134, 134, 134, .167)', tooltip: 'hovered track color of the scrollbar of topbar popover areas' },
      ...
      },
      {
        ...
        variables: [
          ...
          { name: 'MAIN-SCROLLBAR-THUMB-color', default: 'color-mix(in srgb, var(--INTERNAL-MAIN-TEXT-color) 50%, transparent)', tooltip: 'thumb color of the scrollbar of the content' },
          { name: 'MAIN-SCROLLBAR-THUMB-HOVER-color', default: 'color-mix(in srgb, var(--INTERNAL-MAIN-TEXT-color) 75%, transparent)', tooltip: 'hovered thumb color of the scrollbar of the content' },
          { name: 'MAIN-SCROLLBAR-TRACK-color', default: 'rgba(134, 134, 134, .1)', tooltip: 'track color of the scrollbar of the content' },
          { name: 'MAIN-SCROLLBAR-TRACK-HOVER-color', fallback: 'MAIN-SCROLLBAR-TRACK-color', tooltip: 'hovered track color of the scrollbar of the content' },
